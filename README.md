...
As the cores are further instantiated within the FPGA fabric, work will be done to make the main UI compatible with this system.
...
| Vitis HLS            | 2023.2        | Building the PFB and correlator IP cores  |
