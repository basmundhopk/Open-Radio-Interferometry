...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.correlator.autotvin_din_data_0.dat"
         "c.correlator.autotvin_din_data_1.dat"
         "c.correlator.autotvin_din_data_2.dat"
         "c.correlator.autotvin_din_data_3.dat"
         "c.correlator.autotvin_integration_time_frames.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.correlator.autotvout_dout_data_00.dat"
         "rtl.correlator.autotvout_dout_data_11.dat"
         "rtl.correlator.autotvout_dout_data_22.dat"
         "rtl.correlator.autotvout_dout_data_33.dat"
         "rtl.correlator.autotvout_dout_data_01.dat"
         "rtl.correlator.autotvout_dout_data_02.dat"
         "rtl.correlator.autotvout_dout_data_03.dat"
         "rtl.correlator.autotvout_dout_data_12.dat"
         "rtl.correlator.autotvout_dout_data_13.dat"
         "rtl.correlator.autotvout_dout_data_23.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
