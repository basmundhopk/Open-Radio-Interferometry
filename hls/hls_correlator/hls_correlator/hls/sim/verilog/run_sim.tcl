...
if {[file isfile correlator.autotvin.dat]} {
	file delete -force correlator.autotvin.dat
}

if {[file isfile correlator.autotvout.dat]} {
	file delete -force correlator.autotvout.dat
}
