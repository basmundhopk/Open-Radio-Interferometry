...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "correlator.autotvin.dat"
	set constFileTvOut       "correlator.autotvout.dat"
	set constFileHdlTvIn     "correlator.autohdltvin.dat"
	set constFileHdlTvOut    "correlator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
