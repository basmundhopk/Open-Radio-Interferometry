...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("din_data_i0_TDATA", 16, hls_in, 1, "axis", "in_data", 1),
	Port_Property("din_data_i0_TVALID", 1, hls_in, 1, "axis", "in_vld", 1),
	Port_Property("din_data_i0_TREADY", 1, hls_out, 1, "axis", "in_acc", 1),
	Port_Property("din_data_q0_TDATA", 16, hls_in, 2, "axis", "in_data", 1),
	Port_Property("din_data_q0_TVALID", 1, hls_in, 2, "axis", "in_vld", 1),
	Port_Property("din_data_q0_TREADY", 1, hls_out, 2, "axis", "in_acc", 1),
	Port_Property("din_data_i1_TDATA", 16, hls_in, 3, "axis", "in_data", 1),
	Port_Property("din_data_i1_TVALID", 1, hls_in, 3, "axis", "in_vld", 1),
	Port_Property("din_data_i1_TREADY", 1, hls_out, 3, "axis", "in_acc", 1),
	Port_Property("din_data_q1_TDATA", 16, hls_in, 4, "axis", "in_data", 1),
	Port_Property("din_data_q1_TVALID", 1, hls_in, 4, "axis", "in_vld", 1),
	Port_Property("din_data_q1_TREADY", 1, hls_out, 4, "axis", "in_acc", 1),
	Port_Property("din_data_i2_TDATA", 16, hls_in, 5, "axis", "in_data", 1),
	Port_Property("din_data_i2_TVALID", 1, hls_in, 5, "axis", "in_vld", 1),
	Port_Property("din_data_i2_TREADY", 1, hls_out, 5, "axis", "in_acc", 1),
	Port_Property("din_data_q2_TDATA", 16, hls_in, 6, "axis", "in_data", 1),
	Port_Property("din_data_q2_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("din_data_q2_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("din_data_i3_TDATA", 16, hls_in, 7, "axis", "in_data", 1),
	Port_Property("din_data_i3_TVALID", 1, hls_in, 7, "axis", "in_vld", 1),
	Port_Property("din_data_i3_TREADY", 1, hls_out, 7, "axis", "in_acc", 1),
	Port_Property("din_data_q3_TDATA", 16, hls_in, 8, "axis", "in_data", 1),
	Port_Property("din_data_q3_TVALID", 1, hls_in, 8, "axis", "in_vld", 1),
	Port_Property("din_data_q3_TREADY", 1, hls_out, 8, "axis", "in_acc", 1),
	Port_Property("dout_data_0_TDATA", 32, hls_out, 9, "axis", "out_data", 1),
	Port_Property("dout_data_0_TVALID", 1, hls_out, 9, "axis", "out_vld", 1),
	Port_Property("dout_data_0_TREADY", 1, hls_in, 9, "axis", "out_acc", 1),
	Port_Property("dout_data_1_TDATA", 32, hls_out, 10, "axis", "out_data", 1),
	Port_Property("dout_data_1_TVALID", 1, hls_out, 10, "axis", "out_vld", 1),
	Port_Property("dout_data_1_TREADY", 1, hls_in, 10, "axis", "out_acc", 1),
	Port_Property("dout_data_2_TDATA", 32, hls_out, 11, "axis", "out_data", 1),
	Port_Property("dout_data_2_TVALID", 1, hls_out, 11, "axis", "out_vld", 1),
	Port_Property("dout_data_2_TREADY", 1, hls_in, 11, "axis", "out_acc", 1),
	Port_Property("dout_data_3_TDATA", 32, hls_out, 12, "axis", "out_data", 1),
	Port_Property("dout_data_3_TVALID", 1, hls_out, 12, "axis", "out_vld", 1),
	Port_Property("dout_data_3_TREADY", 1, hls_in, 12, "axis", "out_acc", 1),
...
const char* HLS_Design_Meta::dut_name = "pfb_multichannel";
